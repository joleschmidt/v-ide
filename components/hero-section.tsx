    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          <h1 className="text-6xl md:text-8xl font-bold tracking-wide text-[#e2e8f0] leading-tight text-balance">
            Betritt die V<span className="inline-block">Ø</span>IDE.
          </h1>

          <p className="text-xl md:text-2xl tracking-wide text-[#a8a8a8] font-light">
          ...
          <div className="flex justify-center gap-8 pt-8 font-mono text-sm text-[#666666]">
            <div className="border border-[#2a2a2a] px-4 py-2 rounded-md">
              <span className="text-[#4a7a4a]">●</span> 127 Gebiete verfügbar
            </div>
            <div className="border border-[#2a2a2a] px-4 py-2 rounded-md">
              <span className="text-[#4a7a4a]">●</span> 100% Legal
            </div>
          </div>
        </div>
      </div>
